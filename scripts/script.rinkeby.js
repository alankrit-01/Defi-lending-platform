...
async function main() {
  ...
  // console.log(await Dai.balanceOf(myAccount.address));  // 528045.610521629632484982
...
// STEP I BORROWER CAN BORROW ETHER BY SENDING DAI AS COLLATERAL  
  ...
  // await Dai.approve( defi.address,"100000000000000000000"); 
  // console.log(await Dai.allowance( myAccount.address,defi.address));

   // STEP II BORROWER CALL DEPOSIT COLLATERAL
 
  //  await defi.DepositCollateral("100000000000000000000"); 
