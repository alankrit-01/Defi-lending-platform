...
const Borrow = () => {
  return (
    ...
    <Box  sx={{ padding:"10px" , display:"flex" , flexDirection:"column" ,  }}>
        ...
        <div><Typography sx={{ color:"white" , fontFamily:"'Lato', sans-serif" }} variant='h6'>Borrowed Amount: 100</Typography></div>
        <div><Typography sx={{ color:"white" , fontFamily:"'Lato', sans-serif" }} variant='h6'>Interest Amount: 100</Typography></div>
